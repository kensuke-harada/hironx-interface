...
/**
* MotionCommandsPackage/DoubleSeqHelper.java .
...
{
  private static String  _id = "IDL:MotionCommands/DoubleSeq:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (MotionCommandsPackage.DoubleSeqHelper.id (), "DoubleSeq", __typeCode);
    }
    return __typeCode;
  }
